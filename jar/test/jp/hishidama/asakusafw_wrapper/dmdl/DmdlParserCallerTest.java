...
public class DmdlParserCallerTest {
	...
	public void parse_error1() throws URISyntaxException, IOException {
		...
		assertMarker(input.get(0)[0], 2, "DMDLスクリプト \"" + input.get(0)[0]
				+ "\" が正しくありません: 不明な文字「I」が指定されました (構文要素: \"type\")", 1, 13, 1, 13, list.get(0));
	}
	...
	public void parse_error2() throws URISyntaxException, IOException {
		...
		assertMarker(input.get(0)[0], 2, "型 \"com.asakusafw.dmdl.model.AstReferenceType@", 1, 13, 1, 15, list.get(0));
	}
	...
	private void assertMarker(Object uri, int level, String message, int beginLine, int beginColumn, int endLine,
			int endColumn, Object[] actual) {
